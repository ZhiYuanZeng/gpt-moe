...
srun -p llm2 -N 1 --tasks-per-node 8 --gpus-per-task 1 --quotatype=spot python deepy.py train.py -d configs/pythia pythia_1b_from_dense_to_moe_einit_from_single.yml